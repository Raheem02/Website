    ...
    <div className="home__data">
      <h1 className="home__title">
        <p>
          ...
          ㅤHi There! I'm Abdul Raheem
        </p>
      </h1>
      <h3 className="home__subtitle">
        <span style={{ fontWeight: "bold", marginRight: "40px" }}>{typeEffect}
        </span>
      </h3>
      <pre className="home__description">
        Turning ideas into digital wonders.
      </pre>

      <a href="#contact" className="button button--flex" id="text">
        Let's Talk
        <svg
          class="button__icon"
          xmlns="http://www.w3.org/2000/svg"
